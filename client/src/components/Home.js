...
class Home extends Component {
            ...
            quotes: [
                ...
                },
                {
                    'Gandalf': [
                        ...
                        'Do not be so quick to deal death and judgement. Even the very wise do not see all ends.',
    ...
    render() {
        ...
        const slides = this.props.posts.map((item) => {
            return (
                <CarouselItem
                ...
                >
                    ...
                    <CarouselCaption captionText={item.contents} captionHeader={item.title} />
                </CarouselItem>
            );
        });
