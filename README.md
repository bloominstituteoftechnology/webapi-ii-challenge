...
We have provided a `index.js` file and a folder called `data`. Inside the data folder we have added a database with some posts already populated that you can use to test your endpoints as you build them.

index.js already has `db.js` required and ready for you to use when building your endpoints.
